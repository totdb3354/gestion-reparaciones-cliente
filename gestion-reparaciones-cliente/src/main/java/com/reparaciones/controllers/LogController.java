...
public class LogController {
    ...
    private static final List<String> TIPOS_ACCION = List.of(
        ...
        "ELIMINAR_REPARACION",
        "CREAR_ASIGNACION_GLASS", "ACTUALIZAR_ASIGNACION_GLASS", "COMPLETAR_GLASS",
        "EDITAR_GLASS", "MARCAR_INCIDENCIA_GLASS", "ELIMINAR_ASIGNACION_GLASS", "ELIMINAR_GLASS",
        "CREAR_ASIGNACION_PULIDO", "ACTUALIZAR_ASIGNACION_PULIDO", "COMPLETAR_PULIDO_LOTE",
        "ELIMINAR_ASIGNACION_PULIDO", "ELIMINAR_PULIDO",
        "CREAR_PEDIDO", "EDITAR_PEDIDO", "RECIBIR_PEDIDO",
        "RECIBIR_PARCIAL", "CANCELAR_PEDIDO", "CONFIRMAR_PEDIDO", "BORRAR_PEDIDO",
        "CREAR_PEDIDO_OTRO", "EDITAR_PEDIDO_OTRO", "CONFIRMAR_PEDIDO_OTRO", "RECIBIR_PEDIDO_OTRO",
        "RECIBIR_PARCIAL_OTRO", "RECIBIR_RESTO_OTRO", "CANCELAR_PEDIDO_OTRO", "BORRAR_PEDIDO_OTRO",
        ...
        "IMPORTAR_LOTE", "EDITAR_ATRIBUTOS",
        "MARCAR_POR_CERRAR", "QUITAR_POR_CERRAR",
        "ENTREGAR_GLASS", "DESHACER_ENTREGA_GLASS", "EDITAR_PUNTOS",
