...
class ClasificadorImportacionTest {
    ...
    @Test void filaNuevaConStatusCeroEsImportable() {
        var plan = ClasificadorImportacion.clasificar(
                List.of(fila("352500000000061", "iPhone 12", "White", "B1", 0)), MAPEO, Map.of(), Map.of());
    ...
    @Test void agrupaPorBatchNumberUnLotePorCadaUno() {
        var plan = ClasificadorImportacion.clasificar(List.of(
                fila("352500000000061", "iPhone 12", "White", "B1", 0),
                fila("352500000000062", "iPhone 12", "White", "B2", 0),
                fila("352500000000063", "iPhone 12", "White", "B1", 0)), MAPEO, Map.of(), Map.of());
    ...
    @Test void statusDistintoDeCeroNoEntraYSeAvisa() {
        var plan = ClasificadorImportacion.clasificar(
                List.of(fila("352500000000061", "iPhone 12", "White", "B1", 5)), MAPEO, Map.of(), Map.of());
    ...
    @Test void sinBatchNumberEsInvalido() {
        var plan = ClasificadorImportacion.clasificar(
                List.of(fila("352500000000061", "iPhone 12", "White", null, 0)), MAPEO, Map.of(), Map.of());
        assertEquals(ClasificadorImportacion.Destino.INVALIDO, plan.excluidas().get(0).destino());
    }
    ...
    @Test void imeiRepetidoEnElFicheroSoloEntraLaPrimera() {
        var plan = ClasificadorImportacion.clasificar(List.of(
                fila("352500000000061", "iPhone 12", "White", "B1", 0),
                fila("352500000000061", "iPhone 12", "White", "B1", 0)), MAPEO, Map.of(), Map.of());
    ...
    @Test void modeloSinMapearBloqueaLaFila() {
        var plan = ClasificadorImportacion.clasificar(
                List.of(fila("352500000000061", "iPhone 16 eSIM", "White", "B1", 0)),
    ...
    @Test void imeiActivoEsConflictoYFinalOHistoricoEsReentrada() {
        ...
        var plan = ClasificadorImportacion.clasificar(List.of(
                fila("352500000000061", "iPhone 12", "White", "B1", 0),
                fila("352500000000062", "iPhone 12", "White", "B1", 0),
                fila("352500000000063", "iPhone 12", "White", "B1", 0),
                fila("352500000000064", "iPhone 12", "White", "B1", 0)), MAPEO, Map.of(), verif);
