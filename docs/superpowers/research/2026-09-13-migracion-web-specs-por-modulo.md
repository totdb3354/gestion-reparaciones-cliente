...
- Badges columna Estado apilados: Urgente · Por cerrar (`#E0F2F1`/`#00796B`, paleta Glass) · entrega ("→ Jhona" / "Llegó hh:mm", índigo `#E8EAF6`/`#3949AB`) · solicitud (Recibido) (07-08; 08-28).
...
**UX**: badge "→ Jhona" (sin hora) arriba; "Llegó 10:42" / "Llegó 27/08" si no es hoy; tooltips "Entregado a Jhona por Manu, 28/08 10:42" / "Bajado por Manu, 28/08 10:42"; palabra "Llegó" (no "Recibido"); paleta índigo (08-28).
