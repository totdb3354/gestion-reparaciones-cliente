...
8. **Técnico pegajoso por cola** (añadido en el smoke, 2026-09-05): el último técnico asignado en Reparación solo se propone en las entradas nuevas de Reparación, y el de Glass solo en Glass. Antes había una sola memoria y el técnico de reparación se arrastraba a la cola Glass, cuando no tiene por qué reparar la glass la misma persona. Pulido conserva su selector propio (ya iba por separado). **Y se memoriza al marcar, no solo al pulsar Asignar** (cazado en el smoke): antes el pegajoso solo se escribía en `asignarActual`, así que con un modelo no detectado, que impide pulsar Asignar, la marca se perdía al picar el siguiente IMEI y la entrada pendiente no la recordaba al volver. Ahora cada clic en un checkbox (`setOnAction`, solo acción del usuario) actualiza el pegajoso de la cola y, si la entrada es roja, sus propios técnicos; la verde solo cambia con "Guardar cambios".
