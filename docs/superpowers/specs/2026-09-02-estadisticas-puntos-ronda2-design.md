...
- **Modo individual: dos líneas de objetivo** (decisión smoke 2026-09-04): línea 1 = mejora vs su propio histórico (en posesivo: "% de su agosto", "% de un viernes suyo"; "tu/tuyo" para el propio técnico); línea 2 = posición vs la **media por técnico del equipo en el mismo periodo** ("% del equipo (media)", "% del equipo hoy (media)"), técnicos que cuentan con actividad, él incluido; sin actividad → oculta. Cada línea con su propio gris/verde.
