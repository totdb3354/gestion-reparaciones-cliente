...
- **Cálculo**: tarjeta Puntos → `total mes en curso ÷ total mes anterior completo`. Tarjeta Puntos/día (ajuste smoke 2026-09-03) → `acumulado actual ÷ esperado a estas alturas`, donde lo esperado suma por cada laborable transcurrido la **media de ese día de semana en el mes anterior** (mezcla de días igualada: un arranque de mes sin viernes cortos no distorsiona el %; día de semana sin datos → media global por día trabajado del mes anterior; entre paréntesis, la tasa esperada). Los datos de las tarjetas pasan a pedirse en granularidad **día**. En la tasa el % **oscila alrededor de 100** (no acumula). Asumido: el desfase intradía (hoy cuenta entero en el divisor desde las 00:00) deprime la tasa a primera hora y se recupera durante el día; referencia por día de semana con ~4-5 muestras (ruido asumido).
